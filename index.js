    ...
    if (!ques.toDo) {
        ...
        if (conditions = addMore.againAdd) {
            ...
            todos.forEach((item, index) => {
                console.log(chalk.rgb(226, 167, 128).italic(`${index + 1} : ${item}\n`));
            });
            ...
            if (conditions = ans.option) {
                ...
                if (giveOptions.options === "Update") {
                    ...
                    let newTodo = todos.filter(val => val !== userUpdate.update);
                ...
                if (giveOptions.options == "Delete") {
                    ...
                    let newTodos = todos.filter(val => val !== userDelete.delete);
                    todos = [...newTodos];
                    console.log(chalk.magenta.italic(`\nHere is your Todos list : \n`));
                    todos.forEach((item, index) => {
                        console.log(chalk.rgb(226, 167, 128).italic(`${index + 1} : ${item}\n`));
